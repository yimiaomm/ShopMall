...
public class ScllorTabView extends View {
    ...
    public ScllorTabView(Context context) {
        super(context);

}

    public ScllorTabView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ScllorTabView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
